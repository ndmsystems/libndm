#ifndef __NDM_SRC_CHARSET_CP1254_H__
#define __NDM_SRC_CHARSET_CP1254_H__

/**
 * Automatically generated by @c convgen
 * from @c ./MAPPINGS/VENDORS/MICSFT/WINDOWS/CP1254.TXT
...
static const uint16_t CP1254_00000080_000000FF_TO_UNI_[] = {
	0x20ac, 0xd800, 0x201a, 0x0192, 0x201e, 0x2026, 0x2020, 0x2021,
	0x02c6, 0x2030, 0x0160, 0x2039, 0x0152, 0xd800, 0xd800, 0xd800,
	0xd800, 0x2018, 0x2019, 0x201c, 0x201d, 0x2022, 0x2013, 0x2014,
	0x02dc, 0x2122, 0x0161, 0x203a, 0x0153, 0xd800, 0xd800, 0x0178,
...
static inline long conv_cp1254_to_uni_(
		...
		uint32_t *cp)
{
	...
	if (0x80 <= b0) {
		const uint16_t code =
			CP1254_00000080_000000FF_TO_UNI_[b0 - 0x80];
...
static const uint8_t UNI_000000A0_00000192_TO_CP1254_[] = {
...
static const uint8_t UNI_000002C6_000002DC_TO_CP1254_[] = {
	0x88, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x98
};

static const uint8_t UNI_00002013_000020AC_TO_CP1254_[] = {
...
static inline long conv_uni_to_cp1254_(
		uint32_t cp,
		uint8_t *out,
		const size_t out_bytes)
{
	...
	if (0xa0 <= cp && cp <= 0x192) {
		const uint8_t code =
			UNI_000000A0_00000192_TO_CP1254_[cp - 0xa0];
	...
	if (0x02c6 <= cp && cp <= 0x02dc) {
		const uint8_t code =
			UNI_000002C6_000002DC_TO_CP1254_[cp - 0x02c6];
	...
	if (0x2013 <= cp && cp <= 0x20ac) {
		const uint8_t code =
			UNI_00002013_000020AC_TO_CP1254_[cp - 0x2013];
...
#endif /* __NDM_SRC_CHARSET_CP1254_H__ */
