#ifndef __NDM_SRC_CHARSET_CP1026_H__
#define __NDM_SRC_CHARSET_CP1026_H__

/**
 * Automatically generated by @c convgen
 * from @c ./MAPPINGS/VENDORS/MICSFT/EBCDIC/CP1026.TXT
...
static const uint16_t CP1026_00000000_000000FF_TO_UNI_[] = {
...
static inline long conv_cp1026_to_uni_(
		...
		uint32_t *cp)
{
	...
	*cp =
		CP1026_00000000_000000FF_TO_UNI_[*in];

	return 1;
}

static const uint8_t UNI_00000000_000000FF_TO_CP1026_[] = {
	...
	0x5a, 0x69, 0xed, 0xee, 0xeb, 0xef, 0x7b, 0xbf,
	0x80, 0xfd, 0xfe, 0xfb, 0x7f, 0x5a, 0x5a, 0x59,
	0x44, 0x45, 0x42, 0x46, 0x43, 0x47, 0x9c, 0xc0,
	0x54, 0x51, 0x52, 0x53, 0x58, 0x55, 0x56, 0x57,
	0x5a, 0x49, 0xcd, 0xce, 0xcb, 0xcf, 0xa1, 0xe1,
	0x70, 0xdd, 0xde, 0xdb, 0xe0, 0x5a, 0x5a, 0xdf
};

static const uint8_t UNI_0000011E_0000015F_TO_CP1026_[] = {
	0x5a, 0xd0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x5b, 0x79, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
static inline long conv_uni_to_cp1026_(
		uint32_t cp,
		uint8_t *out,
		const size_t out_bytes)
{
	...
	if (cp <= 0xff) {
		const uint8_t code =
			UNI_00000000_000000FF_TO_CP1026_[cp];
	...
	if (0x011e <= cp && cp <= 0x015f) {
		const uint8_t code =
			UNI_0000011E_0000015F_TO_CP1026_[cp - 0x011e];
...
#endif /* __NDM_SRC_CHARSET_CP1026_H__ */
