#ifndef __NDM_SRC_CHARSET_8859_11_H__
#define __NDM_SRC_CHARSET_8859_11_H__

/**
 * Automatically generated by @c convgen
 * from @c ./MAPPINGS/ISO8859/8859-11.TXT
...
static const uint16_t ISO_8859_11_000000A1_000000FB_TO_UNI_[] = {
	...
	0x0e39, 0x0e3a, 0xd800, 0xd800, 0xd800, 0xd800, 0x0e3f, 0x0e40,
...
static inline long conv_8859_11_to_uni_(
		...
		uint32_t *cp)
{
	...
	if (0xa1 <= b0 && b0 <= 0xfb) {
		const uint16_t code =
			ISO_8859_11_000000A1_000000FB_TO_UNI_[b0 - 0xa1];
...
static const uint8_t UNI_00000E01_00000E5B_TO_ISO_8859_11_[] = {
...
static inline long conv_uni_to_8859_11_(
		uint32_t cp,
		uint8_t *out,
		const size_t out_bytes)
{
	...
	if (0x0e01 <= cp && cp <= 0x0e5b) {
		const uint8_t code =
			UNI_00000E01_00000E5B_TO_ISO_8859_11_[cp - 0x0e01];
...
#endif /* __NDM_SRC_CHARSET_8859_11_H__ */
