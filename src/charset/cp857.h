#ifndef __NDM_SRC_CHARSET_CP857_H__
#define __NDM_SRC_CHARSET_CP857_H__

/**
 * Automatically generated by @c convgen
 * from @c ./MAPPINGS/VENDORS/MICSFT/PC/CP857.TXT
...
static const uint16_t CP857_00000080_000000FF_TO_UNI_[] = {
	...
	0x00ba, 0x00aa, 0x00ca, 0x00cb, 0x00c8, 0xd800, 0x00cd, 0x00ce,
	0x00cf, 0x2518, 0x250c, 0x2588, 0x2584, 0x00a6, 0x00cc, 0x2580,
	0x00d3, 0x00df, 0x00d4, 0x00d2, 0x00f5, 0x00d5, 0x00b5, 0xd800,
	0x00d7, 0x00da, 0x00db, 0x00d9, 0x00ec, 0x00ff, 0x00af, 0x00b4,
	0x00ad, 0x00b1, 0xd800, 0x00be, 0x00b6, 0x00a7, 0x00f7, 0x00b8,
	0x00b0, 0x00a8, 0x00b7, 0x00b9, 0x00b3, 0x00b2, 0x25a0, 0x00a0
};

static inline long conv_cp857_to_uni_(
		...
		uint32_t *cp)
{
	...
	if (0x80 <= b0) {
		const uint16_t code =
			CP857_00000080_000000FF_TO_UNI_[b0 - 0x80];
...
static const uint8_t UNI_000000A0_0000015F_TO_CP857_[] = {
...
static const uint8_t UNI_00002500_000025A0_TO_CP857_[] = {
...
static inline long conv_uni_to_cp857_(
		uint32_t cp,
		uint8_t *out,
		const size_t out_bytes)
{
	...
	if (0xa0 <= cp && cp <= 0x15f) {
		const uint8_t code =
			UNI_000000A0_0000015F_TO_CP857_[cp - 0xa0];
	...
	if (0x2500 <= cp && cp <= 0x25a0) {
		const uint8_t code =
			UNI_00002500_000025A0_TO_CP857_[cp - 0x2500];
...
#endif /* __NDM_SRC_CHARSET_CP857_H__ */
