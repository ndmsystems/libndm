#ifndef __NDM_SRC_CHARSET_CP1257_H__
#define __NDM_SRC_CHARSET_CP1257_H__

/**
 * Automatically generated by @c convgen
 * from @c ./MAPPINGS/VENDORS/MICSFT/WINDOWS/CP1257.TXT
...
static const uint16_t CP1257_00000080_000000FF_TO_UNI_[] = {
	0x20ac, 0xd800, 0x201a, 0xd800, 0x201e, 0x2026, 0x2020, 0x2021,
	0xd800, 0x2030, 0xd800, 0x2039, 0xd800, 0x00a8, 0x02c7, 0x00b8,
	0xd800, 0x2018, 0x2019, 0x201c, 0x201d, 0x2022, 0x2013, 0x2014,
	0xd800, 0x2122, 0xd800, 0x203a, 0xd800, 0x00af, 0x02db, 0xd800,
	0x00a0, 0xd800, 0x00a2, 0x00a3, 0x00a4, 0xd800, 0x00a6, 0x00a7,
...
static inline long conv_cp1257_to_uni_(
		...
		uint32_t *cp)
{
	...
	if (0x80 <= b0) {
		const uint16_t code =
			CP1257_00000080_000000FF_TO_UNI_[b0 - 0x80];
...
static const uint8_t UNI_000000A0_0000017E_TO_CP1257_[] = {
	...
	0x00, 0xca, 0xea, 0xdd, 0xfd, 0xde, 0xfe
};

static const uint8_t UNI_000002C7_000002DB_TO_CP1257_[] = {
	0x8e, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0xff, 0x00, 0x9e
};

static const uint8_t UNI_00002013_000020AC_TO_CP1257_[] = {
...
static inline long conv_uni_to_cp1257_(
		uint32_t cp,
		uint8_t *out,
		const size_t out_bytes)
{
	...
	if (0xa0 <= cp && cp <= 0x17e) {
		const uint8_t code =
			UNI_000000A0_0000017E_TO_CP1257_[cp - 0xa0];
	...
	if (0x02c7 <= cp && cp <= 0x02db) {
		const uint8_t code =
			UNI_000002C7_000002DB_TO_CP1257_[cp - 0x02c7];
	...
	if (0x2013 <= cp && cp <= 0x20ac) {
		const uint8_t code =
			UNI_00002013_000020AC_TO_CP1257_[cp - 0x2013];
...
#endif /* __NDM_SRC_CHARSET_CP1257_H__ */
