#ifndef __NDM_SRC_CHARSET_CP1251_H__
#define __NDM_SRC_CHARSET_CP1251_H__

/**
 * Automatically generated by @c convgen
 * from @c ./MAPPINGS/VENDORS/MICSFT/WINDOWS/CP1251.TXT
...
static const uint16_t CP1251_00000080_000000FF_TO_UNI_[] = {
	0x0402, 0x0403, 0x201a, 0x0453, 0x201e, 0x2026, 0x2020, 0x2021,
	0x20ac, 0x2030, 0x0409, 0x2039, 0x040a, 0x040c, 0x040b, 0x040f,
	0x0452, 0x2018, 0x2019, 0x201c, 0x201d, 0x2022, 0x2013, 0x2014,
	0xd800, 0x2122, 0x0459, 0x203a, 0x045a, 0x045c, 0x045b, 0x045f,
...
static inline long conv_cp1251_to_uni_(
		...
		uint32_t *cp)
{
	...
	if (0x80 <= b0) {
		const uint16_t code =
			CP1251_00000080_000000FF_TO_UNI_[b0 - 0x80];
...
static const uint8_t UNI_000000A0_000000BB_TO_CP1251_[] = {
...
static const uint8_t UNI_00000401_00000491_TO_CP1251_[] = {
...
static const uint8_t UNI_00002013_000020AC_TO_CP1251_[] = {
...
static const uint8_t UNI_00002116_00002122_TO_CP1251_[] = {
	0xb9, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x99
};

static inline long conv_uni_to_cp1251_(
		uint32_t cp,
		uint8_t *out,
		const size_t out_bytes)
{
	...
	if (0xa0 <= cp && cp <= 0xbb) {
		const uint8_t code =
			UNI_000000A0_000000BB_TO_CP1251_[cp - 0xa0];
	...
	if (0x0401 <= cp && cp <= 0x0491) {
		const uint8_t code =
			UNI_00000401_00000491_TO_CP1251_[cp - 0x0401];
	...
	if (0x2013 <= cp && cp <= 0x20ac) {
		const uint8_t code =
			UNI_00002013_000020AC_TO_CP1251_[cp - 0x2013];
	...
	if (0x2116 <= cp && cp <= 0x2122) {
		const uint8_t code =
			UNI_00002116_00002122_TO_CP1251_[cp - 0x2116];
...
#endif /* __NDM_SRC_CHARSET_CP1251_H__ */
