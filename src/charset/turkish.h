#ifndef __NDM_SRC_CHARSET_TURKISH_H__
#define __NDM_SRC_CHARSET_TURKISH_H__

/**
 * Automatically generated by @c convgen
 * from @c ./MAPPINGS/VENDORS/APPLE/TURKISH.TXT
...
static const uint16_t TURKISH_00000020_000000FF_TO_UNI_[] = {
...
static inline long conv_turkish_to_uni_(
		...
		uint32_t *cp)
{
	...
	if (0x20 <= b0) {
		const uint16_t code =
			TURKISH_00000020_000000FF_TO_UNI_[b0 - 0x20];
...
static const uint8_t UNI_00000020_0000011F_TO_TURKISH_[] = {
...
static const uint8_t UNI_00000130_00000192_TO_TURKISH_[] = {
...
static const uint8_t UNI_000002C6_000002DD_TO_TURKISH_[] = {
	0xf6, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0xf9, 0xfa, 0xfb, 0xfe, 0xf7, 0xfd
};

static const uint8_t UNI_000003A9_000003C0_TO_TURKISH_[] = {
	0xbd, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xb9
};

static const uint8_t UNI_00002013_00002030_TO_TURKISH_[] = {
...
static const uint8_t UNI_00002202_00002265_TO_TURKISH_[] = {
...
static const uint8_t UNI_0000F8A0_0000F8FF_TO_TURKISH_[] = {
...
static inline long conv_uni_to_turkish_(
		uint32_t cp,
		uint8_t *out,
		const size_t out_bytes)
{
	...
	if (0x20 <= cp && cp <= 0x11f) {
		const uint8_t code =
			UNI_00000020_0000011F_TO_TURKISH_[cp - 0x20];
	...
	if (0x0130 <= cp && cp <= 0x0192) {
		const uint8_t code =
			UNI_00000130_00000192_TO_TURKISH_[cp - 0x0130];
	...
	if (0x02c6 <= cp && cp <= 0x02dd) {
		const uint8_t code =
			UNI_000002C6_000002DD_TO_TURKISH_[cp - 0x02c6];
	...
	if (0x03a9 <= cp && cp <= 0x03c0) {
		const uint8_t code =
			UNI_000003A9_000003C0_TO_TURKISH_[cp - 0x03a9];
	...
	if (0x2013 <= cp && cp <= 0x2030) {
		const uint8_t code =
			UNI_00002013_00002030_TO_TURKISH_[cp - 0x2013];
	...
	if (0x2202 <= cp && cp <= 0x2265) {
		const uint8_t code =
			UNI_00002202_00002265_TO_TURKISH_[cp - 0x2202];
	...
	if (0xf8a0 <= cp && cp <= 0xf8ff) {
		const uint8_t code =
			UNI_0000F8A0_0000F8FF_TO_TURKISH_[cp - 0xf8a0];
...
#endif /* __NDM_SRC_CHARSET_TURKISH_H__ */
