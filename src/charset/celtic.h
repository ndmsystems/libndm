#ifndef __NDM_SRC_CHARSET_CELTIC_H__
#define __NDM_SRC_CHARSET_CELTIC_H__

/**
 * Automatically generated by @c convgen
 * from @c ./MAPPINGS/VENDORS/APPLE/CELTIC.TXT
...
static const uint16_t CELTIC_00000020_000000FF_TO_UNI_[] = {
...
static inline long conv_celtic_to_uni_(
		...
		uint32_t *cp)
{
	...
	if (0x20 <= b0) {
		const uint16_t code =
			CELTIC_00000020_000000FF_TO_UNI_[b0 - 0x20];
...
static const uint8_t UNI_00000020_000000FF_TO_CELTIC_[] = {
...
static const uint8_t UNI_00000131_00000192_TO_CELTIC_[] = {
	...
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0xf8, 0xf9, 0xde, 0xdf, 0xd9,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0xc4
...
static const uint8_t UNI_000003A9_000003C0_TO_CELTIC_[] = {
	0xbd, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xb9
};

static const uint8_t UNI_00001E80_00001EF3_TO_CELTIC_[] = {
...
static const uint8_t UNI_00002013_000020AC_TO_CELTIC_[] = {
	0xd0, 0xd1, 0x00, 0x00, 0x00, 0xd4, 0xd5, 0x00,
	0x00, 0xd2, 0xd3, 0x00, 0x00, 0xa0, 0xe0, 0xa5,
...
static const uint8_t UNI_00002202_00002265_TO_CELTIC_[] = {
...
static inline long conv_uni_to_celtic_(
		uint32_t cp,
		uint8_t *out,
		const size_t out_bytes)
{
	...
	if (0x20 <= cp && cp <= 0xff) {
		const uint8_t code =
			UNI_00000020_000000FF_TO_CELTIC_[cp - 0x20];
	...
	if (0x0131 <= cp && cp <= 0x0192) {
		const uint8_t code =
			UNI_00000131_00000192_TO_CELTIC_[cp - 0x0131];
	...
	if (0x03a9 <= cp && cp <= 0x03c0) {
		const uint8_t code =
			UNI_000003A9_000003C0_TO_CELTIC_[cp - 0x03a9];
	...
	if (0x1e80 <= cp && cp <= 0x1ef3) {
		const uint8_t code =
			UNI_00001E80_00001EF3_TO_CELTIC_[cp - 0x1e80];
	...
	if (0x2013 <= cp && cp <= 0x20ac) {
		const uint8_t code =
			UNI_00002013_000020AC_TO_CELTIC_[cp - 0x2013];
	...
	if (0x2202 <= cp && cp <= 0x2265) {
		const uint8_t code =
			UNI_00002202_00002265_TO_CELTIC_[cp - 0x2202];
...
#endif /* __NDM_SRC_CHARSET_CELTIC_H__ */
