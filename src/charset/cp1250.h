#ifndef __NDM_SRC_CHARSET_CP1250_H__
#define __NDM_SRC_CHARSET_CP1250_H__

/**
 * Automatically generated by @c convgen
 * from @c ./MAPPINGS/VENDORS/MICSFT/WINDOWS/CP1250.TXT
...
static const uint16_t CP1250_00000080_000000FF_TO_UNI_[] = {
	0x20ac, 0xd800, 0x201a, 0xd800, 0x201e, 0x2026, 0x2020, 0x2021,
	0xd800, 0x2030, 0x0160, 0x2039, 0x015a, 0x0164, 0x017d, 0x0179,
	0xd800, 0x2018, 0x2019, 0x201c, 0x201d, 0x2022, 0x2013, 0x2014,
	0xd800, 0x2122, 0x0161, 0x203a, 0x015b, 0x0165, 0x017e, 0x017a,
...
static inline long conv_cp1250_to_uni_(
		...
		uint32_t *cp)
{
	...
	if (0x80 <= b0) {
		const uint16_t code =
			CP1250_00000080_000000FF_TO_UNI_[b0 - 0x80];
...
static const uint8_t UNI_000000A0_0000017E_TO_CP1250_[] = {
	...
	0x00, 0x8f, 0x9f, 0xaf, 0xbf, 0x8e, 0x9e
};

static const uint8_t UNI_000002C7_000002DD_TO_CP1250_[] = {
	0xa1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0xa2, 0xff, 0x00, 0xb2, 0x00, 0xbd
};

static const uint8_t UNI_00002013_000020AC_TO_CP1250_[] = {
...
static inline long conv_uni_to_cp1250_(
		uint32_t cp,
		uint8_t *out,
		const size_t out_bytes)
{
	...
	if (0xa0 <= cp && cp <= 0x17e) {
		const uint8_t code =
			UNI_000000A0_0000017E_TO_CP1250_[cp - 0xa0];
	...
	if (0x02c7 <= cp && cp <= 0x02dd) {
		const uint8_t code =
			UNI_000002C7_000002DD_TO_CP1250_[cp - 0x02c7];
	...
	if (0x2013 <= cp && cp <= 0x20ac) {
		const uint8_t code =
			UNI_00002013_000020AC_TO_CP1250_[cp - 0x2013];
...
#endif /* __NDM_SRC_CHARSET_CP1250_H__ */
