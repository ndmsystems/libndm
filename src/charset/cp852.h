#ifndef __NDM_SRC_CHARSET_CP852_H__
#define __NDM_SRC_CHARSET_CP852_H__

/**
 * Automatically generated by @c convgen
 * from @c ./MAPPINGS/VENDORS/MICSFT/PC/CP852.TXT
...
static const uint16_t CP852_00000080_000000FF_TO_UNI_[] = {
...
static inline long conv_cp852_to_uni_(
		...
		uint32_t *cp)
{
	...
	if (0x80 <= b0) {
		*cp =
			CP852_00000080_000000FF_TO_UNI_[b0 - 0x80];
...
static const uint8_t UNI_000000A0_0000017E_TO_CP852_[] = {
	...
	0x00, 0x8d, 0xab, 0xbd, 0xbe, 0xa6, 0xa7
};

static const uint8_t UNI_000002C7_000002DD_TO_CP852_[] = {
	0xf3, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0xf4, 0xfa, 0x00, 0xf2, 0x00, 0xf1
};

static const uint8_t UNI_00002500_000025A0_TO_CP852_[] = {
...
static inline long conv_uni_to_cp852_(
		uint32_t cp,
		uint8_t *out,
		const size_t out_bytes)
{
	...
	if (0xa0 <= cp && cp <= 0x17e) {
		const uint8_t code =
			UNI_000000A0_0000017E_TO_CP852_[cp - 0xa0];
	...
	if (0x02c7 <= cp && cp <= 0x02dd) {
		const uint8_t code =
			UNI_000002C7_000002DD_TO_CP852_[cp - 0x02c7];
	...
	if (0x2500 <= cp && cp <= 0x25a0) {
		const uint8_t code =
			UNI_00002500_000025A0_TO_CP852_[cp - 0x2500];
...
#endif /* __NDM_SRC_CHARSET_CP852_H__ */
