#ifndef __NDM_SRC_CHARSET_CP1256_H__
#define __NDM_SRC_CHARSET_CP1256_H__

/**
 * Automatically generated by @c convgen
 * from @c ./MAPPINGS/VENDORS/MICSFT/WINDOWS/CP1256.TXT
...
static const uint16_t CP1256_00000080_000000FF_TO_UNI_[] = {
...
static inline long conv_cp1256_to_uni_(
		...
		uint32_t *cp)
{
	...
	if (0x80 <= b0) {
		*cp =
			CP1256_00000080_000000FF_TO_UNI_[b0 - 0x80];
...
static const uint8_t UNI_000000A0_00000192_TO_CP1256_[] = {
...
static const uint8_t UNI_0000060C_000006D2_TO_CP1256_[] = {
	...
	0xd4, 0xd5, 0xd6, 0xd8, 0xd9, 0xda, 0xdb, 0x00,
	0x00, 0x00, 0x00, 0x00, 0xdc, 0xdd, 0xde, 0xdf,
	0xe1, 0xe3, 0xe4, 0xe5, 0xe6, 0xec, 0xed, 0xf0,
	0xf1, 0xf2, 0xf3, 0xf5, 0xf6, 0xf8, 0xfa, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	...
	0x00, 0x00, 0x8d, 0x00, 0x8f, 0x00, 0x00, 0x00,
	...
	0x00, 0x00, 0xaa, 0x00, 0x00, 0xc0, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff
};

static const uint8_t UNI_0000200C_000020AC_TO_CP1256_[] = {
	0x9d, 0x9e, 0xfd, 0xfe, 0x00, 0x00, 0x00, 0x96,
	0x97, 0x00, 0x00, 0x00, 0x91, 0x92, 0x82, 0x00,
	0x93, 0x94, 0x84, 0x00, 0x86, 0x87, 0x95, 0x00,
	0x00, 0x00, 0x85, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x89, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x8b, 0x9b, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
static inline long conv_uni_to_cp1256_(
		uint32_t cp,
		uint8_t *out,
		const size_t out_bytes)
{
	...
	if (0xa0 <= cp && cp <= 0x192) {
		const uint8_t code =
			UNI_000000A0_00000192_TO_CP1256_[cp - 0xa0];
	...
	if (0x060c <= cp && cp <= 0x06d2) {
		const uint8_t code =
			UNI_0000060C_000006D2_TO_CP1256_[cp - 0x060c];
	...
	if (0x200c <= cp && cp <= 0x20ac) {
		const uint8_t code =
			UNI_0000200C_000020AC_TO_CP1256_[cp - 0x200c];
...
#endif /* __NDM_SRC_CHARSET_CP1256_H__ */
